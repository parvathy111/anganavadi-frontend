...
const ApproveBeneficiaries = () => {
  ...
  const fetchBeneficiaries = async () => {
    try {
      ...
      const sortedData = response.data.beneficiaries.sort(
                ...
                {filteredBeneficiaries
                  ...
                  .map((beneficiary) => (
                    <TableRow key={beneficiary._id} hover>
                      <TableCell>
                        {beneficiary.fullname || beneficiary.childname}
                      </TableCell>
                      <TableCell>{beneficiary.address}</TableCell>
                      <TableCell>{beneficiary.phone}</TableCell>
                      <TableCell>
                        {beneficiary.role === "parent"
                          ? "Parent"
                          : "Pregnant/Lactating Woman"}
                      </TableCell>
                      <TableCell>{beneficiary.anganwadiNo}</TableCell>
                      <TableCell>
                        <span
                      ...
                      <TableCell>
                        {beneficiary.status !== "Active" && (
                          <Button
                            ...
                            color="success"
                            size="small"
                            onClick={() => handleApprove(beneficiary._id)}
                          >
                            Approve
                          </Button>
                        )}
                      ...
                      <TableCell>
                        <Button
                          ...
                          color="error"
                          size="small"
                          onClick={() => handleRemove(beneficiary._id)}
                        >
                          Remove
                        </Button>
                      </TableCell>
